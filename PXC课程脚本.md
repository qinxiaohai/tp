...
要为安装Percona Server for MySQL 8.0的系统做准备，请运行percona-release以下命令：
percona-release enable-only ps-80 release
要从测试存储库启用预发布版本 ，请对该testing组件运行percona-release。
percona-release enable ps80 testing
...
8. 修改schema.xml文件，
   ...
   <mycat:schema xmlns:mycat="http://io.mycat/">
     	...
     	<dataHost name="pxc" maxCon="1000" minCon="10" balance="2" 
     		...
     		<writeHost host="W1" url="192.168.4.138:3306" user="admin" 
                           password="123456">  		#写
     			<readHost host="W1R1" url="192.168.4.139:3306" user="admin" 
                           password="123456" />	#读
     		</writeHost>
     		<writeHost host="W2" url="192.168.4.139:3306" user="admin" 
                        password="123456">        #写
     			<readHost host="W2R1" url="192.168.4.138:3306" user="admin" 
                           password="123456" />   #读
     		</writeHost>
     	</dataHost>
   </mycat:schema>
